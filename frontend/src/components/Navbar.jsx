      ...
      <header className="fixed top-0 left-0 right-0 z-50 w-full border-b backdrop-blur-md bg-ocean-navy/95 border-slate-700/80 text-white light:bg-white/95 light:border-slate-200 light:text-ocean-navy shadow-sm transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-3 sm:gap-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            ...
            {/* Quick AI Co-Pilot Button in Header */}
            <button
              onClick={() => setCopilotOpen(true)}
              aria-label="Open Captain's AI Co-Pilot"
              title="Consult Captain's AI Co-Pilot"
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-research-blue/40 light:bg-ice-tint hover:bg-research-blue/60 border border-ice-cyan/40 text-ice-cyan light:text-research-blue text-xs font-semibold shadow-sm hover:scale-105 active:scale-95 transition-all btn-glow-cyan"
            >
              <Sparkles className="w-3.5 h-3.5 text-ice-cyan light:text-research-blue animate-pulse" />
      ...
      {isLeftDrawerOpen && (
        <div className="fixed inset-0 z-50 flex animate-in fade-in duration-200">
          ...
          <aside className="relative w-80 sm:w-96 h-full bg-ocean-navy light:bg-white border-r border-slate-700/80 light:border-slate-200 shadow-2xl flex flex-col justify-between z-10 select-none animate-in slide-in-from-left duration-300">
            ...
            {/* Quick AI Co-Pilot Launcher in Drawer */}
            <div className="px-4 pb-2">
              <button
                ...
                className="w-full flex items-center justify-between p-3 rounded-xl bg-gradient-to-r from-research-blue/40 to-ocean-navy/80 light:from-ice-tint light:to-white border border-ice-cyan/40 hover:border-ice-cyan text-xs font-semibold text-white light:text-ocean-navy shadow-sm transition-all group btn-glow-cyan"
              >
                <div className="flex items-center gap-2.5">
                  <Sparkles className="w-4 h-4 text-ice-cyan light:text-research-blue group-hover:scale-110 transition-transform" />
                  <span>Captain's AI Co-Pilot</span>
                </div>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-ice-cyan/20 text-ice-cyan light:text-research-blue border border-ice-cyan/30">
                  Gemini
                </span>
              </button>
            </div>
