...
const getStoredSettings = () => {
  const endpoint = localStorage.getItem('himyatra_api_endpoint') || 'http://127.0.0.1:8000';
  const apiKey = localStorage.getItem('himyatra_api_key') || 'dev-polar-secret-key-2026';
  const offlineMode = localStorage.getItem('himyatra_offline_mode') === 'true';
